...
> Before diving into this vignette, we recommend reading the vignettes [**Introduction to LaMa**](https://janolefi.github.io/LaMa/articles/Intro_to_LaMa.html) and [**Inhomogeneous HMMs**](https://janolefi.github.io/LaMa/articles/Inhomogeneous_HMMs.html).
...
Again, we use `tpm_p()` and `stationary_p()` to transform the parameters.
```{r visualization}
...
> Continue reading with [**LaMa and RTMB**](https://janolefi.github.io/LaMa/articles/LaMa_and_RTMB.html) or [**Penalised splines**](https://janolefi.github.io/LaMa/articles/Penalised_splines.html).



<!-- ## Nonparametric modeling of the transition probabilities -->
...
<!-- Again, we use `tpm_p()` and `stationary_p()` to transform the unconstrained parameters to working parameters. -->
